    ...
    showData() {
      ...
      console.log(this.showChart)
       ...
       async getData() {
         ...
         this.DefactoTotal=adelaideData.p_tot_married_de_facto
         this.NotMarriedTotal=adelaideData.p_tot_not_married
       ...
       for (const age of this.ageGroups) {
          ...
          this.people_marriedArray.push(adelaideData[`${ageKey}_marrd_reg_marrge`]);
          this.people_deFactoArray.push(adelaideData[`${ageKey}_married_de_facto`]);
          this.people_notMarriedArray.push(adelaideData[`${ageKey}_not_married`]);
      }

         // console.log(this.people_notMarriedArray);

         this.initChart2(this.pie_chart,this.RegisteredTotal,this.DefactoTotal,this.NotMarriedTotal,'Marital Status of Adelaide city in Pie Chart')
         this.initChart3(this.bar_chart, this.ageGroups,this.people_marriedArray,this.people_deFactoArray,this.people_notMarriedArray,'Marital Status of Adelaide city in Bar Chart')
         } catch (error) {
