...
export default {
  ...
  methods: {
    ...
    async get_data() {
      try {
        const response = await axios.get('http://172.26.135.144:8080/brisbane/305011105');
        ...
        this.initChart3(this.people_chart, this.ageGroups,this.people_marriedArray,this.people_deFactoArray,this.people_notMarriedArray,'Marital Status of Brisbane CBD')
